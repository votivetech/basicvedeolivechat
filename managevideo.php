<?php require_once('header.php'); ?>
      <section id="fullcontent">
        <div class="clear"></div>
  	 <h2 class="black">Manage Videos</h2>
      <hr>
        <div class="r_left">  
          <div class="padding_top">
                ...
                <div align="center">
                	 <form method="post" action="<?php echo base_url(); ?>user/managevideos/<?php  if(isset($editvideo->videoid)){echo 'Edit/'.$editvideo->videoid;}?>" enctype="multipart/form-data">
                            ...
                            <td width="50%" valign="top">
                            	<table cellpadding="0" cellspacing="0" width="100%">
                                	<tr>
                                     ...
                                     <input type="file" name="videofile">
                                      <span class="error"><br><?php if(isset($addmsg['verror'])){ echo $addmsg['verror'] ;} ?></span><?php } ?>
                                      </td>
                                    </tr>
                                    <tr>
                                      ...
                                      <span class="error"><br><?php echo strip_tags(form_error('videoname')); ?></span>
                                      </td>
                                    </tr>
									 <tr>
                                ...
                                <span class="error"><br><?php if(isset($addmsg['imgerror'])){ echo $addmsg['imgerror'] ;} ?></span>
                                    ...
                                    <tr>
                                      ...
                                      <span class="error"><br><?php echo strip_tags(form_error('videoprice')); ?></span>
                                      </td>
                                    </tr>
                                    <tr>
                                      ...
                                      <select name="videocategory" class="login" style="padding-right:0px; width:248px;">
                                        ...
                                        <span class="error"><br><?php echo strip_tags(form_error('videocategory')); ?></span>
                                        </td>
                                    </tr>
                                     <tr>
                                    	<td height="50">&nbsp;</td>
                                       <td>
                                       <input type="submit" name="addvideo" value="<?php if(isset($editvideo->videoid)){ ?>Update <?php }else{ ?>Add<?php } ?>">
                                      </td>
                                    </tr>
                                </table>
                            </td>
	  ...
	  <div class="r_left">  
          <div class="padding_top">
                ...
                <form method="post" action="<?php echo  base_url(); ?>user/managevideos">
                	<table cellpadding="0" cellspacing="0" width="100%">
                    	<tr>
					...
					$searchvcategory=substr($inputs['searchvcategory'],strpos($inputs['searchvcategory'],'+')+1);
                            ...
                            <td><select name="searchuser" class="login" style="padding-right:0px; width:100px;">
                            	<option value="">All</option>
                                <?php if(isset($uploadedby)){
									foreach($uploadedby as $user){
									 ?>
	...
	<div class="flag"></div>
      ...
      <!--<video width="180" height="160" controls>
        ...
        <div class="video_footer" align="left" >
             <table cellpadding="0" cellspacing="0" width="100%">
             	<tr>
                	<td width="10%" height="30" align="center"><img src="<?php echo base_url(); ?>/content/images/zoom.png" height="15" width="15"></td>
                    <td width="15%" align="left" ><a href="<?php echo base_url(); ?>user/managevideos/Edit/<?php echo $video->videoid; ?>" class="editlink">Edit</a></td>
                    <td width="15%" align="center"> <img src="<?php echo base_url(); ?>/content/images/ko.png" height="15" width="15"></td>
                    <td width="15%" align="left" ><a href="<?php echo base_url(); ?>user/managevideos/delete/<?php echo $video->videoid; ?>" class="editlink">Delete</a></td>
                    ...
                    <td width="25%" align="left"> <a href="<?php echo base_url(); ?>user/managevideos/changestatus/<?php echo $video->videoid; ?>" class="editlink"><?php if($video->status==1){ ?> Active<?php }else{ ?> Inactive<?php } ?></a></td>
                </tr>
            </table>
             </div>
      </div>
